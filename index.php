...
.contactus:before{
    ...
    bottom: 0;
    right:0;
    background:linear-gradient(20deg,#708090 100%, #fff 0%);
    z-index: -1;
}
.formbutton button{
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <p class="big-text">Online Banking System</p>
          </div>

          <div class="col-sm-6">
            
            <img src="ihome.jpg" class="img-fluid" width="560" height="345" style="margin-top:20px;">
                ...
                <div class="col-lg-8 col-md-8 col-10 offset-lg-2 offet-md-2-col col-1">
                    <form action="/action_page.php">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Name" id="username" required autocomplete="off">
                        </div>
                        <form action="/action_page.php">
                            <div class="form-group">
                              
                              <input type="email" class="form-control" placeholder="Email" id="email" required autocomplete="off">
                            </div>
                            <form action="/action_page.php">
                                <div class="form-group">
                                  
                                  <input type="number" class="form-control" placeholder="Mobile number" id="mobile" required autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label for="comment">Comment:</label>
                                    <textarea class="form-control" rows="4" id="comment" placeholder="Your Queries or Issues"></textarea>
                                  </div>
