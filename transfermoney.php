...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center">SPARKS BANK</a>
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:76px;background-color:#98AFC7;border-radius:10px;color:white" >
              <form method="POST">  
                                              
 <?php
$con=mysqli_connect("localhost","id17282168_root","OnBanking@123","id17282168_banking");
$ids=$_GET['idtransfer'];
$showquery="select * from `Customers` where C_id=$ids ";
...
if(isset($_POST['submit']))
{
    ...
    $ids=$_GET['idtransfer'];
    $senderquery="select * from `Customers` where `C_id`=$ids ";
    ...
    $receiverquery="select * from `Customers` where Name='$Receiver_name'";
    ...
    if($arrdata['Current_Balance'] >= $Sender)
    {
      ...
      $increase_receiver=$receiver_arr['Current_Balance'] + $Sender;
       $query="UPDATE `Customers` SET `Current_Balance`= $decrease_sender  where `C_id`=$ids ";
       $rec_query="UPDATE `Customers` SET `Current_Balance`= $increase_receiver where `C_id`=$id_receiver ";
